...
class TestCleanCommand:
    ...
    def test_clean_no_artifacts(self, mock_context, mock_run_command):
        ...
        # Should complete without errors, but shouldn't try to remove non-existent directories
        # The function should skip non-existent directories
        assert True  # Test that clean() completes without exception
